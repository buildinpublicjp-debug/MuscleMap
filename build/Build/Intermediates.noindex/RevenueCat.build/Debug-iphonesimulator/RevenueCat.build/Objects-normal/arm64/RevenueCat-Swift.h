...
typedef SWIFT_ENUM_NAMED(NSInteger, RCPurchasesAreCompletedBy, "PurchasesAreCompletedBy", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCStoreKitVersion, "StoreKitVersion", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, RCStoreMessageType, "StoreMessageType", closed) {
